...
# Padding and collate functions for dataloader's batch
# Keep each sample (of that modality) the same length, and pad the batch to the max length in the batch
...
# Padding and collate functions for dataloader's batch with max padding
# Keep each sample (of that modality) the same length, and pad the batch to the max length in the batch, with a max padding length to avoid too much padding.
